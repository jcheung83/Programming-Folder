...
my_list.add_to_front("are").add_to_front("lists").add_to_front("Linked").add_to_back("fun!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").add_to_back("!").print_values()
my_list.insert_at("really", 9).print_values()